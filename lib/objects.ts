...
export const OBJECTS: RealtyObject[] = [
  ...
  },
  {
    ...
    status: "soon",
    tagline: "Дом бизнес-класса — эстетика как образ жизни.",
    description: "Современный 5-этажный жилой дом бизнес-класса с витражными окнами, потолками 3 м, Face ID и умными замками. Дизайнерские подъезды, закрытая территория, собственные гаражи.",
  ...
  },
  {
    ...
    description: "Масштабный проект нового квартала. Коммерческие помещения на первых этажах, подземный паркинг и современная инфраструктура. Регистрируйтесь на старт продаж.",
